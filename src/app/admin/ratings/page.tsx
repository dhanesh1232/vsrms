...
export const metadata: Metadata = { title: "Ratings Overview" };
export default function Page() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4 text-center p-8">
      ...
      <h1 className="text-2xl font-bold">Ratings Overview</h1>
      <div className="flex gap-2">
        <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold">Admin</span>
